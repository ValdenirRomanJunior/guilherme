...
import principalBanner from '../../assets/images/banner-1.png';
import principalBanner2 from '../../assets/images/banner-2.png';
import principalBannerMobile from '../../assets/images/banner-principal-2.png';
import principalBanner2Mobile from '../../assets/images/banner-principal-2-guilherme-mobile.png';
    ...
    return (
        ...
        <MediaQuery query="(min-width: 1024px)">
           ...
           <div className="session-agent-content-wrapper">   
            ...
            <h3>Conectando pessoas a grandes negócios</h3>
            <p>CRECI TO-4033</p>
            </div>
            ...
            <p className="agent-name">CRECI TO-4033</p>
            </div> 
